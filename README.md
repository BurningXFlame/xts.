...
# XTS - Secure and Convenient Cross-Region Transmission for Cloud

XTS is a Cloud-Native Cross-Region Transmission Service which
improves the security of Cross-Region Transmission,
and provides Adaptive Hierarchical Transmission Control.
...
XTS is Truly-Distributed, Load-Balanced and Horizontally-Scalable. This architecture provides the best scalability and reliability. In other words:

- XTS effortlessly scales as your business grows. In theory, there’s no scalability cap, i.e. you can achieve unlimited throughput by specifying an unlimited number of replicas.
- Zero downtime during scaling out/in.
- Zero downtime during upgrade.

XTS also makes some enhancements in fine-grained reliability.
...
### Adaptive Hierarchical Transmission Control

XTS can adapt to real-time traffic, and ensure priority guarantee, maximum bandwidth utilization, and fairness at the same time.
...
spec:
  ...
  externalAddr: someHost:somePort
  # other fields ...
```
...
spec:
  ...
  internalPort: somePort
  # the destination region
  dstRegion: someNamespace/someName
  # the destination address in the destination region
  dstAddr: someHost:somePort
```
...
To learn more, view the [complete list of all features](https://www.bxflame.com/xts/doc/pricing/), and go through the docs for detailed description of each feature.
